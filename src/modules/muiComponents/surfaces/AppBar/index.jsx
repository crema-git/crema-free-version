    ...
    <>
      ...
      <AppGridContainer>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Basic App Bar" component={ButtonAppBar} source={ButtonAppBarSource} noScrollbar />
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Search App Bar" component={SearchAppBar} source={SearchAppBarSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Menu App Bar" component={MenuAppBar} source={MenuAppBarSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Dense App Bar" component={DenseAppBar} source={DenseAppBarSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Bottom App Bar" component={BottomAppBar} source={BottomAppBarSource} />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Hide App Bar " component={HideAppBar} source={HideAppBarSource} />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Elevate App Bar " component={ElevateAppBar} source={ElevateAppBarSource} />
        </Grid>
        <Grid item xs={12} md={6}>
