  ...
  return (
    <>
      ...
      <AppGridContainer>
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard title="ThemeHelper" component={ThemeHelper} source={ThemeHelperSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Server Side" component={ServerSide} source={ServerSideSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="UseWidth" component={UseWidth} source={UseWidthSource} noScrollbar />
        </Grid>
      </AppGridContainer>
    </>
  );
