...
import SimpleNoSsrSource from './SimpleNoSsr?raw';

import FrameDeferring from './FrameDeferring';
import FrameDeferringSource from './FrameDeferring?raw';
    ...
    <>
      ...
      <AppGridContainer>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Simple No Ssr" component={SimpleNoSsr} source={SimpleNoSsrSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
