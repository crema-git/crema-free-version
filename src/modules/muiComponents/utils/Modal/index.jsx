...
import BasicModalSource from './BasicModal?raw';

import KeepMountedModal from './KeepMountedModal';
import KeepMountedModalSource from './KeepMountedModal?raw';

import NestedModal from './NestedModal';
import NestedModalSource from './NestedModal?raw';

import TransitionsModal from './TransitionsModal';
import TransitionsModalSource from './TransitionsModal?raw';
    ...
    <>
      ...
      <AppGridContainer>
        <Grid item xs={12} md={6}>
          <AppComponentCard title="Basic Modal" component={BasicModal} source={BasicModalSource} noScrollbar />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
