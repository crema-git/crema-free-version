...
const SidebarBgWrapper = ({ children }) => {
  const { sidebarBgColor, sidebarTextColor, mode, allowSidebarBgImage, sidebarBgImageId } = useSidebarContext();
  return (
    <Box
      sx={[
        {
...
SidebarBgWrapper.propTypes = {
  ...
  sidebarBgImageId: PropsTypes.oneOfType([PropsTypes.string, PropsTypes.number]),
};
